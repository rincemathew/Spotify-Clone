...
import TextNavbar from "../components/shared/TextNavbar";
  ...
  return (
    <div className="h-full w-full flex">
      ...
      <div className="h-full w-4/5 bg-app-black overflow-auto">
        <div className="w-full h-1/10 bg-black bg-opacity-30 flex items-center justify-end">
          <div className="w-1/2 flex h-full">
            <div className="w-3/5 flex justify-around items-center">
              <TextNavbar displayText={"Premium"}></TextNavbar>
              <TextNavbar displayText={"Support"}></TextNavbar>
              <TextNavbar displayText={"Download"}></TextNavbar>
              <div className="h-1/2 border-r border-white"></div>
            </div>
            <div className="w-2/5 flex justify-around h-full items-center">
              <TextNavbar displayText={"Sign up"}></TextNavbar>
        ...
        <PlayListView titleText="Focus" cardsData={focusCardsData}></PlayListView>
        <PlayListView titleText="Spotify Playlists" cardsData={spotifyPlaylistsCardData}></PlayListView>
        <PlayListView titleText="Sound of India" cardsData={focusCardsData}></PlayListView>
        </div>
      </div>
    </div>
  );
